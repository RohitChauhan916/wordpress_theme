        ...
        foreach( $menu_items as $menu_item ) {
            if( $menu_item->menu_item_parent == 0 ) {
                ...
                if( $bool == true && count( $menu_array ) > 0 ) {
                    ...
                    $menu_list .= '<a class="dropdown-button" data-activates="dropdown1" href="javascript:void(0)"><span>'.$menu_item->title.'</span> <i class="material-icons right">arrow_drop_down</i></a>';
